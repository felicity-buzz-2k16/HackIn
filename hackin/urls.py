...
#    url(r'^index$',views.index, name = 'index'),
    ...
    url(r'^accessdenied', views.accessdenied),
    url(r'^leaderboard', views.leaderboard),
    url(r'^$', views.getstarted),
...
#    url(r'^temptemptemp/$', views.temptemptemp),
#    url(r'^this_is_the_way_we_check_mail/$', views.this_is_the_way_we_check_mail)
]
